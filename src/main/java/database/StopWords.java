...
/**
 * the stop word class implement from google
 * @author google
 *
 */
public class StopWords {
	...
	/**
	 * return if the word is a stemmed stop word
	 * @param word
	 * @return
	 */
	...
	/**
	 * remove the stop word from the string
	 * @param string
	 * @return
	 */
	...
	/**
	 * remove the stemmed stop word from the string
	 * @param string
	 * @return
	 */
