...
public class BaseServlet extends HttpServlet {
	...
	protected String header(String title, HttpServletRequest request) {
		...
		sb.append("<h1>This is Note Sharing APP</h1>");
		sb.append("<a href=\"mainPage\" style=" + ButtonStyle + ">Main Page</a>");
		sb.append("<a href=\"userInfo\" style=" + ButtonStyle + ">User Info</a>");
		sb.append("<a href=\"noteBox\" style=" + ButtonStyle + ">Note Box</a>");
		...
		sb.append("<option value=\"name\">Title</option>");
		sb.append("<option value=\"body\">Body</option>");
		sb.append("<option value=\"creator\">Author</option>");
		sb.append("</select>");
		sb.append("Query: ");
