...
public class RegisterServlet extends BaseServlet{
	...
	/**
	 * check if the user id is already exist
	 * then check if the password and confirm password is matched
	 * display the welcome page if succeed
	 * or the error detail and back to the register page
	 */
